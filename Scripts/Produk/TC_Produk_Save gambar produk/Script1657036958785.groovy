...
Mobile.tap(findTestObject('Produk/save_image_button'), 0)

AppiumDriver<?> driver = MobileDriverFactory.getDriver()

def toast = driver.findElementByXPath('//android.widget.Toast[@text=\'Image has been downloaded and saved on gallery.\']')
